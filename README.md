...
This is the client-side of a full-stack social media application using the MERN stack where users can view, search, and like various posts (memories) and add their own memories, likes, and comments by signing in locally or with Google.
